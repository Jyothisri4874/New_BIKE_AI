...
import DealerBookingsPage from './dealer/DealerBookingsPage'
import DealerJobCardPage from './dealer/DealerJobCardPage'

import PublicTrackingPage from './customer/PublicTrackingPage'
          ...
          <BrowserRouter>
            <Routes>
              ...
              >
                ...
                <Route path="job-cards/:id" element={<DealerJobCardPage />} />
